<template>
    <div>
        <div>
            Offers HiRel memory products in monolithic form 16K to 4Mb and MCMs or modules up to 64Gb in all package types (-55°C to +125°C) and special specifications to +175°C.
