<template>
    <div>
        <div>
            Force Technologies can provide virtually any diode or transistor for your HiRel application, critical testing and design support. Equivalents which conform to JAN, JANTX or JANTXV screening are possible.
